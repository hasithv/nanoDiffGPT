...
lol  `¯\_(ツ)_/¯`. Not bad for a character-level model. Better results are quite likely obtainable by instead finetuning a pretrained GPT-2 model on this dataset